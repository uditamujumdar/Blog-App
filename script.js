...
const defaultBlogs = [
    {
      id: `${Date.now() + 1}`, 
      imageUrl: "https://plus.unsplash.com/premium_photo-1683121710572-7723bd2e235d?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      blogTitle: "Exploring AI",
      blogType: "Technology",
      blogDescription: "Artificial Intelligence (AI) is a broad field that simulates human intelligence in machines...",
    },
    {
      id: `${Date.now() + 2}`,
      imageUrl: "https://images.unsplash.com/photo-1593642634367-d91a135587b5",
      blogTitle: "Tech Gadgets",
      blogType: "Gadgets",
      blogDescription: "From smartphones to drones, the world of tech gadgets is evolving at a rapid pace...",
    },
    {
      id: `${Date.now() + 3}`,
      imageUrl: "https://images.unsplash.com/photo-1517134062979-e1234be8a085?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      blogTitle: "Web Development",
      blogType: "Programming",
      blogDescription: "Web development has transformed with modern frameworks like React, Angular...",
    },
  ];
...
const loadData = () => {
	...
	if (!getInitialData) {
        defaultBlogs.forEach((blogObject) => {
        ...
        updateLocalStorage(); // Save default blogs to localStorage
        return;
      }
